...
def create_wwnn_pool(handle, obj, pool_desc, pool_name, pool_range):
    try:
        ...
        mo = handle.AddManagedObject(
            ...
            {FcpoolInitiators.NAME: pool_name,
             ...
             FcpoolInitiators.PURPOSE: "node-wwn-assignment",
        ...
        print "Created WWNN pool " + pool_name + \
              " with range " + start_range + " to " + end_range

    except CreateWwnnPoolError:
        print("Error: Unable to create WWNN pool " + pool_name)
